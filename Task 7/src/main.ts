...
{
  console.log("Tuščias string'ų sąrašas");
...
{
  console.log("String'ų sąrašas");
  console.log(stringList);

  console.log('Pridedamas mazgas 1', 'pirmas');
  stringList.unshift('pirmas');
  console.log('Sąrašas po pridėjimo', {...stringList});

  console.log('Pridedamas mazgas 2', 'antras');
...
{
  console.log("string'ų sąrašo spausdinimas");
