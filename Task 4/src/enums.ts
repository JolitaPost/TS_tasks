...
enum WeekDays {
  ...
  console.group('Literal types - užduotys');
  {
    ...
    const city1: LithuanianCities = LithuanianCities.Vilnius;
    const city2: LithuanianCities = LithuanianCities.Kaunas;
    const city3: LithuanianCities = LithuanianCities.Klaipeda;
    const city4: LithuanianCities = LithuanianCities.Siauliai;
    const city5: LithuanianCities = LithuanianCities.Panevezys;
    ...
    const largestCountries: LargestCountries[] = [LargestCountries.China, LargestCountries.India, LargestCountries.Indonesia, LargestCountries.Pakistan, LargestCountries.USA];
